...
export default function Footer() {
    return (
        <footer>
            <div id='theme_cont'>
                <button title='theme' id='themeb' onClick={toggleTheme}>Toggle Theme</button>
            </div>
            <div id='credits_cont'>
                <div>
                    <p>Powered by</p>
                    <div>
                    <a href='https://vercel.com/home' about='_blank' title='vercel'>
            ...
            <div id='swc_cred'>
                    ...
                    <div>
                    <a href='https://swc.rs/' about='_blank' title='swr'>swc.rc</a>
                    </div>
            </div>
        </footer>
    )
